...
Route::get('/jabraactionwatchlist', 'OptionController@jabardastActionWatchlist')->name('jabardastActionWatchlist');
Route::get('/hundred', 'OptionController@moreThanHundredIV')->name('moreThanHundredIV');
